...
const AuthForm = () => {
  ...
  <div className="flex flex-col md:flex-row md:items-center md:justify-center lg:flex-row items-center gap-12 md:gap-5 lg:gap-28 relative">
    
    {/* Left Card */}
    <div className="bg-gradient-to-b from-[#2b2b2d] to-[#1b1c1e] rounded-2xl shadow-xl border border-blue-600">
      <div className="bg-[#57565B] rounded-2xl p-6 w-[340px] md:w-[380px] lg:w-[450px]">
    ...
    <div className="hidden md:block lg:block relative">
      <img
        ...
        className="max-w-[250px] md:max-w-[350px] lg:max-w-[550px] relative"
      />
    </div>
  </div>
</div>
