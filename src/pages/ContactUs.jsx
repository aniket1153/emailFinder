...
const ContactUs = () => {
  return (
    <>
      <div className=" min-h-screen py-8 px-4">
        <div className="w-full max-w-7xl mx-auto md:mx-5 lg:mx-28 flex flex-col lg:flex-row gap-8 relative">
  {/* Left Content */}
  <div className="w-full lg:w-1/2">
    <h2 className="font-spaceGrotesk text-4xl sm:text-5xl text-white mb-5">
  ...
  {/* Right Form */}
  <div className="bg-white/8 backdrop-blur-lg border border-white/10 
                  w-full lg:w-1/2 max-w-[608px] p-6 sm:p-8 
    ...
    {/* Name input */}
    <div className="h-[60px] w-full rounded-full bg-white/8 backdrop-blur-lg border border-white/10 px-4 flex items-center">
      <input
        type="text"
        placeholder="Your Name"
        className="bg-transparent w-full outline-none text-md text-white"
      />
    </div>
    ...
    {/* Message box */}
    <div className="h-[160px] w-full rounded-2xl border border-gray-500 mt-5 bg-white/8 backdrop-blur-lg p-4">
