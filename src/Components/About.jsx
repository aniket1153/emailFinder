      ...
      <div className="flex flex-col-reverse py-12  lg:flex-row items-center justify-center gap-12 lg:gap-60">
        ...
        <div className="flex flex-col gap-6 max-w-xl">
          <div className="flex flex-col gap-3">
            <h1 className="text-4xl md:text-5xl  text-white font-spaceGrotesk">About Us</h1>
            <h2 className="text-2xl md:text-3xl text-[#ceced8] font-spaceGrotesk">Helping You Connect with the Right </h2>
            <h2 className="text-2xl md:text-3xl text-[#ceced8] font-spaceGrotesk"> People Accurately and Reliably</h2>
          </div>

          <div className="text-[#8D909C] text-lg  flex flex-col gap-2 font-inter ">
            <div>
...
<div>            <p>Our goal? To make finding and verifying emails easy, fast, and reliable—whether you're running a solo campaign or managing an enterprise pipeline.</p></div>
          </div>
        </div>
